				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
					...
					<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
						...
						<div class="w-md-400px">
							<!--begin::Form-->
							<form class="form w-100" method="POST" action="{{route("register")}}"  id="kt_sign_up_form" data-kt-redirect-url="../../demo20/dist/authentication/layouts/overlay/sign-in.html" action="#">
								@csrf
                                <!--begin::Heading-->
								...
								<div class="fv-row mb-8">
									<!--begin::UserName-->
									<input type="text" placeholder="Enter username" name="name" autocomplete="off" class="form-control bg-transparent" />
									@error('name')
